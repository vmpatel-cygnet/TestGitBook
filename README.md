...
> {"jobs":\[{"namespace":"event",”action:"inviteContacts","params":{"event":1,"contacts":\[1,2,3\]}},{"namespace":"event",”action:"inviteContacts","params":{"event":2,"contacts":\[1,2,4\]}},\],"callbackUrl":"[http://example.callback.url.com](http://example.callback.url.com)"}
